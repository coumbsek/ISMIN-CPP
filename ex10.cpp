...
class Point{
	...
	public:
		...
		bool operator== (const Point& p)  {return (this->x==p.x and this->y==p.y) ? true : false;};
...
class Segment{
	...
	public:
		...
		friend ostream& operator<<( ostream& flux, Segment& s);

		bool operator== (const Segment& s)  {return (this->ori==s.ori and this->ext==s.ext) ? true : false;}
